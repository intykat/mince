...
<Table>
  ...
  <Tr>
    ...
    <Tr>
      <Td>Replicate to SelectClients </Td>
      <Td>✅</Td>
      <Td>❌</Td>
    </Tr>
    <Tr>
...
local GameState = Mince:GetState("GameState") -- Create a server state named "GameState"
```
...
local GameState = Mince:GetState("GameState") -- Create a state named "GameState"
...
for _, Player in game.Players:GetPlayers() do -- In case our client already exists
	PlayerAdded(Player)
end
```
